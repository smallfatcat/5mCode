local spawnPos = vector3(1726.0500488281, 3239.4248046875, 41.545928955078)
...
Citizen.CreateThread(function()
    while true do
        ...
        if timerVisible then
            --[[timerText("Timer: "..tostring(timer/1000))
            timerTextA("60: "..tostring(timeA/1000))
            timerTextB("100: "..tostring(timeB/1000))
            timerTextC("140: "..tostring(timeC/1000))--]]
            timerTextBox()
        end
